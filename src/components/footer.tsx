      ...
      <section className="w-full px-sectionpxsm pb-10 lg:hidden">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col mt-14 gap-2">
            ...
            <p className="text-[15px] text-neutral-500 font-supportingfont">
              ...
              <span className="hover: underline">
                <Link href="https://wa.me/628123024660">+62 812 3024 660</Link>
              </span>{" "}
              <span className="block">(WhatsApp only)</span>
            </p>
            <p className="text-[15px] text-neutral-500 font-supportingfont">
              Email -{" "}
              <span className="hover:underline">
          ...
          <div className="flex flex-col mt-12 gap-2">
            <p className="text-2xl text-black font-medium">Office Studio</p>
            <p className="text-[15px] text-neutral-500 font-supportingfont">
          ...
          <div className="flex flex-col mt-12 gap-2">
            <p className="text-2xl text-black font-medium">Social Media</p>
            <Link
        ...
        <div className="flex items-start justify-between gap-24 px-sectionpxlg 2xl:px-sectionpx2xl pb-20">
          ...
          <div className="flex justify-between w-full">
            <div className="flex flex-col w-full h-full">
              <h5 className="text-xl text-black font-medium">Contact Us</h5>
            ...
            <div className="flex flex-col w-full h-full">
              <h5 className="text-xl text-black font-medium">Office Studio</h5>
              <p className="text-sm text-neutral-500 font-supportingfont mt-3">
                Raya wendit barat No. 7 Malang, 65154
              </p>
            </div>
