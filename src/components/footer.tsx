      ...
      <section className="w-full px-sectionpxsm pb-10 lg:hidden">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col mt-14 gap-2">
            <p className="text-2xl text-black font-medium">Studionarta</p>
          ...
          <div className="flex flex-col mt-12 gap-2">
            ...
            <Link href="/project">
              <p className="text-lg text-black font-medium">Project</p>
            </Link>
            <Link href="/contact">
              <p className="text-lg text-black font-medium">Contact</p>
            </Link>
          </div>

          <div className="flex flex-col mt-12 gap-2">
            <p className="text-2xl text-black font-medium">Contact</p>
            <p className="text-sm text-neutral-500 font-supportingfont">
          ...
          <div className="flex flex-col mt-12 gap-3">
            ...
            >
              <div className="py-2 border-b-[1px] w-fit border-black border-opacity-25">
                <p className="text-lg text-black font-medium">INSTAGRAM</p>
              </div>
            </Link>
          </div>
        </div>
        ...
        <div className="flex items-start justify-between px-sectionpxlg pb-20">
          <div className="flex gap-20 w-full h-full">
            ...
            <div className="flex flex-col h-full w-full">
              <h5 className="text-xl text-black font-medium">Studionarta</h5>
              <p className="text-sm text-neutral-500 font-supportingfont">
                CP - Devina{" "}
          ...
          <div className="flex flex-col gap-5 h-full">
            ...
            >
              <div className="pb-2 border-b-[1px] w-fit border-black border-opacity-25">
                <p className="text-sm text-black font-medium">INSTAGRAM</p>
              </div>
            </Link>
          </div>
        </div>
